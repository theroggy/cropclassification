...
def prepare_input(input_parcel_filepath: str
    ...
    if force == False and os.path.exists(output_imagedata_parcel_input_filepath):
    ...
    parceldata_buf_nopoly = parceldata_buf_notempty[-parceldata_buf_notempty['geometry'].geom_type.isin(['Polygon', 'MultiPolygon'])]
    ...
    parceldata_buf_poly = parceldata_buf_notempty[parceldata_buf_notempty['geometry'].geom_type.isin(['Polygon', 'MultiPolygon'])]
